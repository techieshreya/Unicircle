      ...
      <div class="grid sm:grid-cols-2 items-start gap-14 p-8 mx-auto max-w-4xl bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md font-[sans-serif]">
            ...
            <ul class="mt-4">
              <li class="flex items-center">
                ...
                <a
                  ...
                  class="text-cyan-600 text-sm ml-4"
                >
        ...
        <form class="ml-auo space-y-4">
          <input
            type="text"
            placeholder="Name"
            class="w-full text-gray-800 rounded-md py-2.5 px-4 border text-sm outline-cyan-800"
          />
          <input
            type="email"
            placeholder="Email"
          ...
          <textarea
            placeholder="Message"
            rows="6"
            class="w-full text-gray-800 rounded-md px-4 border text-sm pt-2.5 outline-cyan-800"
          ></textarea>
          <button
            type="button"
            class="text-white bg-cyan-700 hover:bg-cyan-800 rounded-md text-sm px-4 py-3 w-full !mt-6"
          >
            Send
          </button>
        </form>
